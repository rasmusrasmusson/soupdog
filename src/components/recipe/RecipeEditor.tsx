          ...
          {group.outputName.trim() && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 6, flexWrap: 'wrap' }}>
              ...
              <div style={{ display: 'flex', gap: 4, alignItems: 'center', flexWrap: 'wrap' }}>
                {/* Always store yield in grams internally; display in all 4 units */}
                {(['g','kg','ml','l'] as const).map(u => {
                  // Convert stored grams to display unit
                  const storedG = group.outputQuantityValue ?? 0;
                  let displayVal = storedG;
                  if (u === 'kg' || u === 'l') displayVal = Math.round(storedG / 1000 * 10000) / 10000;
                ...
                <input
                  ...
                  title="Enter value in grams to override"
                />
                {yieldUserEdited && (
                  <button
                    onClick={() => {
                      ...
                      if (calc > 0) {
                        onChange({ ...groupRef.current, outputQuantityValue: calc });
