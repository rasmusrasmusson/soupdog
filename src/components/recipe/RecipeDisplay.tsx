  ...
  return (
    <div className="px-4 md:px-8 py-6 space-y-8">
      ...
      {/* Linked dishes (multi-dish meals): reused recipes slotted into this meal.
          ...
          recipe; if expand_by_default, its steps are shown inline as a sealed block. */}
      {Array.isArray(recipe.subRecipes) && recipe.subRecipes.length > 0 && (
        <section style={{ marginTop: 8 }}>
          <SectionHeader title="Dishes in this meal" meta={`${recipe.subRecipes.length} from your recipes`} />
