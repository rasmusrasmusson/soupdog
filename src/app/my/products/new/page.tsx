    ...
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 24px 80px' }}>
      ...
      <div style={{ marginBottom: 28, borderBottom: B, paddingBottom: 16 }}>
        ...
        <p style={{ fontFamily: MONO, fontSize: 11, color: 'var(--muted)', marginTop: 6, lineHeight: 1.6 }}>
          A product is a specific packaged ingredient — a leaf in the ingredient taxonomy.
          Cooking instructions are added as regular recipes using this product as an ingredient.
        </p>
      </div>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0,
        ...
        <span style={{ fontFamily: MONO, fontSize: 10, color: 'var(--muted)' }}>
          Product metadata only — cooking instructions are added as recipes
        </span>
        <div style={{ display: 'flex', gap: 8 }}>
