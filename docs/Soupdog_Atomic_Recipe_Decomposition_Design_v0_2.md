# Soupdog — Atomic Recipe Decomposition: editorial → executable graph (v0.2)
...
**v0.2 (2026-06-07)** resolves the four open questions from v0.1 and — the biggest
change — reframes decomposition from "linearize into atomic steps" to "build the
executable DEPENDENCY GRAPH (DAG)."
