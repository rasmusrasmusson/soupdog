...
2. One ingredient per add-node, always. If the source says "add the flour, sugar and salt", emit THREE separate add nodes. This enables exact add-order, parallel prep, and per-portion divergence. The display layer re-bundles them; you must not.
